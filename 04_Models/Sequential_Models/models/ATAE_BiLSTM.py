...
class ATAE_BiLSTM(nn.Module):
    def __init__(self, args, embedding_matrix=None, aspect_embedding_matrix=None):
        ...
        self.lstm = DynamicRNN(args.embed_dim, args.hidden_dim, num_layers=1, batch_first=True, dropout=args.dropout, bidirectional=True, rnn_type="LSTM")
        self.attention = AttentionAspect(embed_dim_k=args.hidden_dim * 2, embed_dim_q=args.embed_dim, score_function="mlp")
